 ...
 * Quan ly phan quyen truy cap endpoint, quy trinh dang nhap/dang xuat va ma hoa
 * mat khau.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
     ...
     * Su dung BCryptPasswordEncoder de bam mat khau cua nguoi dung mot cach an
     * toan.
     *
    ...
    /**
     * Cau hinh bo loc bao mat (Security Filter Chain) de ap dung phan quyen va quy
     * trinh xac thuc.
     *
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/login", "/register", "/trains", "/trains/detail/*", "/error")
                        .permitAll()
                        ...
                        .requestMatchers("/dashboard/seller/**", "/trains/new", "/trains/edit/**", "/trains/delete/**")
                        .hasAnyRole("SELLER", "ADMIN")
                        // Yeu cau vai tro BUYER hoac ADMIN de dat ve va huy ve
                        .requestMatchers("/dashboard/buyer/**", "/tickets/book/**", "/tickets/cancel/**")
     ...
     * Dieu huong nguoi dung ve trang Dashboard tuong ung dua theo vai tro (Role)
     * cua ho.
     *
