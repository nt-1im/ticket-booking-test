...
public class Train {
     ...
     */
    public Train(String trainNumber, Route route, LocalDate departureDate, LocalTime departureTime, LocalDate arrivalDate, LocalTime arrivalTime, double price, int totalSeats, User seller) {
